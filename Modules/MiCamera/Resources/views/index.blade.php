        ...
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-8">
                <div class="hero-content text-right">
                    ...
                    <div>
                        <h2 dir="rtl" style="color:#ff6700;font-size: 52px;"> 13,400.00 <span> دج </span> <strike style="color:#807f7f;font-size: 36px;" >17,400.00 <span> دج </span></strike></h2> 
                        <h3 class="text-secondary " style="margin-top: -10px;">مليون و300 و40  ألف</h3>
                    </div>
