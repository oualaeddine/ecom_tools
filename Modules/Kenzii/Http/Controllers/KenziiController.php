...
class KenziiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('kenzii::index', compact('page_title'))->with('fb_pixel', $this->fbPixel(1));;
    }

    public function checking()
    {
        $page_title = 'Kenzii | checking';
        return view('kenzii::checking', compact('page_title'))->with('fb_pixel', $this->fbPixel(1));;
    }
    ...
    public function product(Request $request)
    {
        ...
        return view('kenzii::product', compact('page_title'))->with('fb_pixel', $this->fbPixel(1));;
    }
    ...
    public function checkout(Request $request)
    {
        ...
        $price_info = DB::table('store_products')->where('store_id', 1)->where('product_id', 1)->first();
        ...
        return view('kenzii::checkout', compact('page_title', 'color', 'price_info', 'product'))->with('fb_pixel', $this->fbPixel(1));;
    }
    ...
    public function checkout_confirm(Request $request)
    {
        ...
        $price_info = DB::table('store_products')->where('store_id', $order->store_id)->where('product_id', $product_id)->first();
...
/*
        ...
        return view('kenzii::thankyou', compact('page_title'))->with('fb_pixel', $this->fbPixel(1));;
    }
    ...
    public function faq()
    {
        ...
        return view('kenzii::faq', compact('page_title'))->with('fb_pixel', $this->fbPixel(1));
    }
    ...
    {
        return view('kenzii::most')->with('page_title', 'Title here')->with('fb_pixel', $this->fbPixel(1));;
    }

    public function rating(Request $request)
    {
        return view('kenzii::rating')->with('page_title', 'Title here')->with('fb_pixel', $this->fbPixel(1));;
    }
