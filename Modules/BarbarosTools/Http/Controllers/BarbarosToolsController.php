...
class BarbarosToolsController extends Controller
{
  ...
  /*       $host = request()->getHost();
    ...
    public function checkout(Request $request)
    {
        ...
        return redirect()->route('barbarostools.thanks', [$request->firstname, $store->id])->with('fb_pixel', $store->fb_pixel);
    }
    ...
    public function thanks(Request $request, $name, $store)
    {
        ...
        return view('barbarostools::pages.thanks')->with('page_title', $name . ' | شكرا لك')->with('fb_pixel', $store->fb_pixel);
    }
