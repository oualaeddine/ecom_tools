        ...
        {{-- <div class="card"> --}}
            <div class="card-body text-center mt-8 mb-8" dir="rtl">
                ...
                <div class="lx-cart-thanks-btns">
                    ...
                    <a href="{{url('/')}}" class="btn btn-shop" style="font-size:16px;background-color:#36098B;color:white !important;width:180px;" >إكمال التسوق <i class="d-icon-bag" style="font-size:14px"></i></a>
                </div>
            </div>
