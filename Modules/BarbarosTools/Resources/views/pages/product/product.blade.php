                ...
                <div class="lx-product-main-img ">
                    ...
                    @if ($store_product->discount != 0)
                                ...
                                <div class="product-label-group" >
                                    <label class="product-label label-sale" style="background-color: #36098B">{{$store_product->discount}} % تخفيض</label>
                                </div>
...
--}}
            ...
            <div class="product-footer" style="  text-align: center;" >
                ...
                <div class="social-links mr-4">
                    <a href="javascript:;" class="btn-product btn-compare price-text"><i class="d-icon-check icons"></i>الدفع يكون مقسم 4 أجزاء  </a>
                </div>
                ...
                <div class="social-links mr-4">
                    <a href="tel:0770496866" target="_blanck" class="btn-product btn-compare price-text" ><i class="d-icon-phone icons"></i> خدمة الزبائن عبر الهاتف (0770496866)</a>
                </div>
