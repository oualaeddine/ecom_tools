            ...
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <div class="text-center" dir="rtl">
                        ...
                        <h2 class="price fw-bold mb-0 mt-2" style=" color:#36098B" dir="rtl">{{number_format($product->price * $quantity, 2, ',', '.')  }} دج / 4 أجزاء كل 15 يوم</h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form action="{{route('barbarostools.checkout.store')}}" method="post" id="checkout_form">
                                        ...
                                        <div class="mb-3 col-md-12 " dir="rtl">
                                            <label for="state" class="form-label">الدفع عن طريق البطاقة (SOON) <span class="text-danger"> * </span></label>
                                        <img width="50" height="50" src="https://epayement.elit.dz/ressources/img/carte_CIB.jpg" alt="<label>EDAHABIA</label>" class="AMOP-logo AH_LAPOSTE-logo">
                                        </div>                                        
