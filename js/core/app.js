          ...
          for (var i = 0; i < data.listItems.length; i++) {
            ...
            if (data.listItems[i].name.toLowerCase().indexOf(value) == 0 && a < 5) {
             ...
             /*  var url_order_show = "route('orders.show',':id')";
              ...
              $startList += '<li class="auto-suggestion ' + $activeItemClass + '">' + '<a class="d-flex align-items-center justify-content-between w-100" href=' + base_url + '>' + '<div class="d-flex justify-content-start align-items-center">' + '<span>' + data.listItems[i].name + '</span>' + '</div>' + $bookmarkIcon + '</a>' + '</li>';
              a++;
            }
          }
